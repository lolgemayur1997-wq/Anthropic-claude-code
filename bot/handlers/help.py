...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "📌 Create & schedule Pinterest pins\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text = (
        ...
        "*Pinterest:*\n"
        "/newpin - Create a Pinterest pin\n"
        "/pinterest - Pinterest menu\n"
        "/pinschedule - View pin queue\n"
        "/pinstats - Pinterest analytics\n"
        ...
        "3. Create pins with /newpin\n"
        "4. Publish with /publish\n"
        "5. Share on social with /postnow"
    )
